...
import {View, Text, ScrollView, ImageBackground, TouchableNativeFeedback, Vibration} from 'react-native';
  ...
  return (
    ...
    <View
          ...
          style={{
            ...
            <TouchableNativeFeedback onPress={() => {navigation.navigate('ListCategories2');Vibration.vibrate(DURATION);}}>
